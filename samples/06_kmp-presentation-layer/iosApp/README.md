...
This is a real SwiftUI application target for the `KMP Presentation Layer` sample. The target compiles every Swift file under `Sources/` and links the KMP framework or frameworks listed below.
