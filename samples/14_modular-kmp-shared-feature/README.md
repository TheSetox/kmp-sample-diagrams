...
```sh
./gradlew -p samples/14_modular-kmp-shared-feature :desktopApp:compileKotlin
./gradlew -p samples/14_modular-kmp-shared-feature :androidApp:assembleDebug
./gradlew -p samples/14_modular-kmp-shared-feature :featureTwoSharedFeature:compileKotlinDesktop
```
